...
public class MyPaneAddMeeting extends MyPaneAdd {
	...
	public MyPaneAddMeeting(String title, int id, String method, String date, String time, int fkClient, MyPaneMenu paneMenu, Controller controller) {
		super(title + " un rendez-vous", id, method, paneMenu, controller);
